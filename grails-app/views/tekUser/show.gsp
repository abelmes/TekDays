...
<body>
<a href="#show-tekUser" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-tekUser" class="content scaffold-show" role="main">
    ...
    <ol class="property-list tekUser">
        ...
        <g:if test="${tekUserInstance?.fullName}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="fullName-label"><g:fieldValue bean="${tekUserInstance}"
                                                                                            field="fullName"/></span>
        ...
        <g:if test="${tekUserInstance?.userName}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="userName-label"><g:fieldValue bean="${tekUserInstance}"
                                                                                            field="userName"/></span>
        ...
        <g:if test="${tekUserInstance?.email}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="email-label"><g:fieldValue bean="${tekUserInstance}"
                                                                                         field="email"/></span>
        ...
        <g:if test="${tekUserInstance?.website}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="website-label"><g:fieldValue bean="${tekUserInstance}"
                                                                                           field="website"/></span>
        ...
        <g:if test="${tekUserInstance?.bio}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="bio-label"><g:fieldValue bean="${tekUserInstance}"
                                                                                       field="bio"/></span>
        ...
        <g:if test="${tekUserInstance?.password}">
            <li class="fieldcontain">
                <span id="password-label" class="property-label"><g:message code="tekUser.password.label"
                                                                            default="Password"/></span>

                <span class="property-value" aria-labelledby="password-label"><g:fieldValue bean="${tekUserInstance}"
                                                                                            field="password"/></span>
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${tekUserInstance?.id}"><g:message code="default.button.edit.label"
                                                                                      default="Edit"/></g:link>
